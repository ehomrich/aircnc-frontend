...
Repository for Aircnc Frontend, developed during OmniStack Week #9, a free crash course by [Rocketseat](https://rocketseat.com.br/).

Built with [ReactJS](https://reactjs.org) and [Socket.IO](https://socket.io/) (client).
